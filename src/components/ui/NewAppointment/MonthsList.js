...
export const MonthsList = () => {
  ...
  return (
    <>
      ...
      <div className='-inset-0 w-full h-full align-middle object-center grid w-full h-44 shadow-xl rounded grid-cols-3 gap-2
          ...
          (month, i) =>
            i >= thisMonth && (
              <button
                ...
                className={
                  i === currentMonth
                    ? 'grid-col p-2 text-indigo-500 cursor-pointer w-full focus:text-indigo-400 focus:outline-none dark:text-indigo-300'
